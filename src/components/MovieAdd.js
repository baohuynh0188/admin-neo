...
const MovieAdd = () => {
    ...
    return (
        <div className="container-fluid px-4">
            ...
            <div className="row">
                <form
                    onSubmit={handleSubmit(onSubmitAddMovie)}
                // onSubmit={handleSubmit(onSubmit)}
                >
                    <div className="row">
                        <div className="col-6 mb-3">
                            <label htmlFor="title" className="form-label">Title</label>
                            <input {...register("title")} type="text" className={`form-control ${errors.title ? 'is-invalid' : 'is-valid'}`} id="title" placeholder="Title" />
                            <p className="text-danger">{errors.title?.message}</p>
                        </div>

                        <div className="col-6 mb-3">
                            <label htmlFor="language" className="form-label">Language</label>
                            <input {...register("language")} type="text" className={`form-control ${errors.language ? 'is-invalid' : 'is-valid'}`} id="language" placeholder="Language" />
                    ...
                    <div className="row">
                        ...
                        <div className="col-3 mb-3">
                            ...
                            <input {...register("duration")} type="number" className={`form-control ${errors.duration ? 'is-invalid' : 'is-valid'}`} id="duration" placeholder="Duration" />
                            <p className="text-danger">{errors.duration?.message}</p>
                        </div>

                        <div className="col-3 mb-3">
                            <label htmlFor="year" className="form-label">Release year</label>
                            <input {...register("year")} type="number" className={`form-control ${errors.year ? 'is-invalid' : 'is-valid'}`} id="year" placeholder="Year" />
                            <p className="text-danger">{errors.year?.message}</p>
                        </div>

                        <div className="col-3 mb-3">
                            <label htmlFor="url" className="form-label">Url</label>
                            <input {...register("url")} type="text" className={`form-control ${errors.url ? 'is-invalid' : 'is-valid'}`} id="url" placeholder="Url embed" />
                    ...
                    <div className="row">
                        ...
                        <div className="col-6 mb-3">
                            ...
                            <Controller
                                ...
                                />}
                            />
                            {errors.publish && <p className="text-danger">Publish required"</p>}
                        </div>
                    </div>
                    <div className="mb-3">
                        <label htmlFor="content" className="form-label">Content</label>
                        <textarea {...register("content")} type="text" className={`form-control ${errors.content ? 'is-invalid' : 'is-valid'}`} id="content" placeholder="Content"></textarea>
